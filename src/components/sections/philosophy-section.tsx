...
const titles = [
  "Science-Driven Recovery.",
  "Athlete-Focused Methods.",
  "Proven Results.",
];
      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            {("Our recovery programs combine cutting-edge sports science with personalized coaching. We optimize your body's natural healing processes through advanced techniques, nutrition planning, and performance monitoring to help you recover faster and perform better.").split(" ").map((word, index, array) => {
